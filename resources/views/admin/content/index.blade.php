...
@section('content')
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <table class="layui-table" lay-data="{url:'{{ route('admin::content.list', ['entity' => $entity]) }}?{{ request()->getQueryString() }}', page:true, limit:50, id:'test', toolbar:'<div><a href=\'{{ route('admin::content.create', ['entity' => $entity]) }}\'><i class=\'layui-icon layui-icon-add-1\'></i>新增{{ $entityModel->name }}内容</a></div>'}" lay-filter="test">
                <thead>
                <tr>
