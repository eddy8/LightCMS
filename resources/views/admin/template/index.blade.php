...
@section('content')
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <table class="layui-table" lay-data="{url:'{{ route('admin::template.list') }}?{{ request()->getQueryString() }}', page:true, limit:50, id:'test', toolbar:'<div><a href=\'{{ route('admin::template.create') }}\'><i class=\'layui-icon layui-icon-add-1\'></i>新增模板</a></div>'}" lay-filter="test">
                <thead>
                <tr>
